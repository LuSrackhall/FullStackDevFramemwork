...
export OHOS_NDK_HOME=/mnt/d/safe/command-line-tools/sdk/default/openharmony
export LOG_ADAPTOR_HOME=/mnt/d/safe/FullStackDevFramework/go-sdk/full/harmony/log-adaptor
...
go build --tags fts5 -ldflags "-s -w" -buildmode=c-shared -v -o libfull.so  .